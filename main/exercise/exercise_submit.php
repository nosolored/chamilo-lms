...
if (!empty($error)) {
    ...
    echo '<script>
        ...
        function save_now(question_id, url_extra) {
            ...
            dataparam += my_choice_agree ? ("&" + my_choice_agree) : "";
            dataparam += my_choice_disagree ? ("&" + my_choice_disagree) : "";
            dataparam += my_choice_agree_scale ? ("&" + my_choice_agree_scale) : "";
            dataparam += my_choice_agree_reorder ? ("&" + my_choice_agree_reorder) : "";
