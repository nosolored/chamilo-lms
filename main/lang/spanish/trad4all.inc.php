...
$DescriptionFront = "Descripción principal";
$DescriptionRear = "Descripción trasera";
$Certify = "Certifica";
$CertificateType = "Tipo certificado";
$CertifyThat = "CERTIFICA QUE";
$StudentCourseInfo = 'Datos del alumno y curso';
$StudentData = "Datos estudiante";
$CourseData = "Datos curso";
$Modality = "Modalidad";
$Contents = "Contenidos";
$ContentsToShow = "Contenidos a mostrar";
$ContentsCourseDescription = 'Usar apartado "Descripcion del curso" > "Contenidos"';
$ContentsIndexLearnpath = "Usar indice de lecciones";
$ContentsCustom = "Usar contenido personalizado";
$Dates = "Fechas";
$CourseDeliveryDates = "Fechas de impartición del curso";
$Custom = "Personalizado";
$UseDateSessionAccess = "Usar fechas de acceso a la sesión";
$ExpectionPlace = "Lugar expedición";
$DateExpediction = "Fecha expedición";
$UseDateEndAccessSession = "Usar fecha fin de acceso de la sesión";
$UseDateDownloadCertificate = "Usar fecha de descarga del certificado";
$UseCustomDate = "Usar fechas personalizadas";
$LogosSeal = "Logos / Sellos";
$LogoLeft = "Logo izquierda";
$LogoCenter = "Logo central";
$LogoRight = "Logo derecha";
$Seal = "Sello";
$Signature1 = "Firma 1";
$Signature2 = "Firma 2";
$Signature3 = "Firma 3";
$Signature4 = "Firma 4";
$SignatureText1 = "Texto firma 1";
$SignatureText2 = "Texto firma 2";
$SignatureText3 = "Texto firma 3";
$SignatureText4 = "Texto firma 4";
$OtherOptions = "Otras opciones";
$MarginRight = "Margen derecho";
$SetDefaultTemplate = "Establecer plantilla por defecto";
$MessageDefaultTemplate = "Guardar esta personalización por defecto para cursos y sesiones sin certificados definidos";
$None = "Ninguno";
$ErrorTemplateCertificate = "No hay una plantilla definida para el certificado. No existe plantilla por defecto.";
$DateStartEnd = "Con Fecha de inicio y Fecha fin: ";
$ExpedictionIn = "Expedido en";
$Signatures = "Firmas";
$BackgroundCertificate = "Imagen de fondo del certificado";
$Background = "Fondo";
$CertificateSetting = "Configuración Certificado";
?>