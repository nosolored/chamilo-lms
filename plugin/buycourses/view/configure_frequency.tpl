...
<div class="table-responsive">
    <table class="table table-striped table-hover">
        ...
        <tr class="sale-columns">
            ...
            <th>{{ 'SubscriptionPeriodName'|get_plugin_lang('BuyCoursesPlugin') }}</th>
        ...
        {% for frequency in frequencies_list %}
            <tr class="sale-row">
                ...
                <div class="btn-group btn-group-xs" role="group" aria-label="...">
                    <a title="{{ 'ConfigureCoupon'|get_plugin_lang('BuyCoursesPlugin') }}" href="{{ _p.web_plugin ~ 'buycourses/src/configure_frequency.php?' ~ {'action': 'delete_frequency', 'd': frequency.duration, 'n': frequency.name}|url_encode() }}"
